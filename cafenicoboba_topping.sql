...
CREATE TABLE `topping` (
  `id_topping` char(4) NOT NULL,
  `nama_topping` varchar(45) DEFAULT NULL,
...
INSERT INTO `topping` VALUES ('T00','No Topping',0),('T01','Extra Boba',5000);
...
-- Dump completed on 2024-10-30 19:33:03
